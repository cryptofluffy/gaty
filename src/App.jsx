...
import { Activity, Server, Network, Router, Shield, Settings, Key, LogOut, Wifi, Globe, ChevronDown } from 'lucide-react';
...
function App() {
  ...
  const tabs = [
    ...
    { id: 'ports', label: 'Port Forwards', icon: Wifi },
  ...
  const renderActiveComponent = () => {
    switch (activeTab) {
      ...
      case 'ports':
        return <PortManager licenseInfo={licenseInfo} />;
      case 'gateway':
            ...
            <div className="language-selector">
              ...
              {showLanguageDropdown && (
                <div className="language-dropdown">
                  <button onClick={() => { setLanguage('en'); setShowLanguageDropdown(false); }}>
                    🇺🇸 English
                  </button>
                  <button onClick={() => { setLanguage('de'); setShowLanguageDropdown(false); }}>
                    🇩🇪 Deutsch
                  </button>
                  <button onClick={() => { setLanguage('fr'); setShowLanguageDropdown(false); }}>
                    🇫🇷 Français
                  </button>
                  <button onClick={() => { setLanguage('es'); setShowLanguageDropdown(false); }}>
                    🇪🇸 Español
                  </button>
                  <button onClick={() => { setLanguage('it'); setShowLanguageDropdown(false); }}>
                    🇮🇹 Italiano
                  </button>
                </div>
              )}
